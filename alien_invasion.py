...
class AlianInvasion:
    """ゲームアセットと動作を管理する全体的なクラス"""
    
    def __init__(self):
        """ゲームを初期化しゲームのリソースを作成する"""
        pygame.init()
